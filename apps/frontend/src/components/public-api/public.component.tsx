...
const PublicApiContent = () => {
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      <div className="flex flex-col">
        <h3 className="text-[20px]">Building your {APP_NAME} payload</h3>
        <div className="text-customColor18 mt-[4px] whitespace-pre-line">
          ...
          We have created an easy way to build your {APP_NAME} payload to schedule
          posts. {'\n'}
          You can use the {APP_NAME} wizard, and schedule a post with our UI, after
