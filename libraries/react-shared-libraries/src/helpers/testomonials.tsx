...
export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about {APP_NAME}, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        {APP_NAME} seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host {APP_NAME}!
  ...
  },
  {
    ...
    content: (
      <>
        {APP_NAME} changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with {APP_NAME}, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + {APP_NAME} =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: {APP_NAME}, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using {APP_NAME}, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose {APP_NAME}? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        {APP_NAME} is an open-source scheduling tool that allows you to plan and
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, {APP_NAME} can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        {APP_NAME} makes it so easy to plan ahead. The AI suggestions are relevant,
